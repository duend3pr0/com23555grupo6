...
public class BookDAO {
    ...
    private static final String SQL_INSERT = "INSERT INTO libros(nombre,autor, cantPaginas, precio, copias, imagen)";
    private static final String SQL_UPDATE = "UPDATE libros SET nombre = ?, autor = ?, cantiPaginas = 2";
